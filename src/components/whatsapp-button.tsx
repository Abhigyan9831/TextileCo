...
export default function WhatsAppButton({ currentPage }: WhatsAppButtonProps) {
  // Hide on Products Page
  if (currentPage === 'products') return null

  const phoneNumber = '918013244984'
  const message = encodeURIComponent(
    "Hello! I would like to inquire about your premium manufacturing services. Please let me know how we can proceed."
  )
